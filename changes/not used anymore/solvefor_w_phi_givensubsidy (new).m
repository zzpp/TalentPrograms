...
function [W,PHI,S,PworkYWM,MWM,THome_CohortOrder]=solvefor_w_phi_givensubsidy(wm_tauw_mat,wm_tauh_mat,eta,beta,theta,gam,sigma,phiFarm,lambda,Tbar,ShowData);
