...
for loopthome=1:2;  % The first time we use time-varying thome, the second we impose the min across decades
    ...
    for t=1:Nyears;
        ...
        wHomerangetable(t,loopthome)=wHome;
...
printoutziho(['solveforw_test_' num2str(solveforstage) '.xlsx'],1, wHomeoriginal,numberjtable,minerrtable,wHomerangetable,wHometable);
